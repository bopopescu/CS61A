...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.stored_money < self.price:
            return 'You must deposit ${0} more.'.format(self.price - self.stored_money)
        
        change = self.stored_money - self.price
        self.stored_money, self.stock = 0, self.stock - 1
    ...
    def deposit(self, money): 
        ...
        self.stored_money += money
        return 'Current balance: ${0}'.format(self.stored_money)
...
def store_digits(n):
    ...
    def link_digits(s):
        ...
        s = Link(n//10%10, s)
        n //= 10
        return link_digits(s)
    return link_digits(Link(n%10)) 
    """
